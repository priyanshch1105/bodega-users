...
import 'package:bodega_delivery/repository/screens/Order/frequentreorderscreen.dart';
import 'package:bodega_delivery/repository/screens/Order/pastorderscreen.dart';
...
class OrderHistoryReorderScreen extends StatelessWidget{

  final List<String> options = [
    "Past orders(status,rating",
    "Frequently Reorder items"
  ];

  final List<Widget> screens = [
    PastOrderScreen(),
    FrequentReorderScreen()
  ];
